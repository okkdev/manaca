defmodule ManacaWeb.Router do
  ...
  scope "/", ManacaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ManacaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ManacaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ManacaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ManacaWeb do
    ...
    live_session :current_user,
      on_mount: [{ManacaWeb.UserAuth, :mount_current_user}] do
