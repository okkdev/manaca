defmodule ManacaWeb.UserLiveTest do
  use ManacaWeb.ConnCase

  import Phoenix.LiveViewTest
  import Manaca.AccountsFixtures

  @create_attrs %{tokens: 42, firstname: "some firstname", lastname: "some lastname", email: "some email", card_id: "some card_id"}
